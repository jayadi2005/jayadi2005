...
<meta name="viewport" content="width=device-width, initial-scale=1.0"> <meta http-equiv="X-
...
<input type="text" name="role" class="form-control" value="Guest" readonly> </div>
